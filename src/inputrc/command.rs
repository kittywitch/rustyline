...
impl Command {
    ...
    pub fn category(&self) -> Category {
        ...
        match *self {
            ...
            Complete | InsertCompletions | PossibleCompletions | MenuComplete
            | MenuCompleteBackward => Category::Complete,
            BackwardKillLine | KillLine | BackwardKillWord | KillWord | UnixWordRubout => {
                Category::Kill
            }
